...
[![NPM Package](https://img.shields.io/npm/v/vaporyjs-account.svg?style=flat-square)](https://www.npmjs.org/package/vaporyjs-account)
[![Build Status](https://travis-ci.org/vaporyjs/vaporyjs-account.svg?branch=master)](https://travis-ci.org/vaporyjs/vaporyjs-account)
[![Coverage Status](https://img.shields.io/coveralls/vaporyjs/vaporyjs-account.svg?style=flat-square)](https://coveralls.io/r/vaporyjs/vaporyjs-account)
...
NOTE: this is different from [vaporyjs-accounts](https://github.com/vapjs/vaporyjs-accounts) which should be used if you want to key management and web3 sugar.
